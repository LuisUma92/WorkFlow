...
status: partially-fixed   # 2026-09-10: #1-#4 fixed, #5 (LOW) open — see Summary
findings_summary:
  critical: 0
  high: 1
  medium: 3
...
| 4 | MEDIUM | `prisma/cli.py` (C1/C2) | TOCTOU on idempotent write | **fixed** (2026-09-10) — exclusive create `Path.open("x")` in `accept_to_note.py`; race tests in `test_accept_to_note{,_bulk}.py`; `tasks/requests/2026-09-10-accept-to-note-atomic-create.md` |

...
2. **LaTeX Style Files** — Custom macros for exercises, physics, formatting,
   and evaluation
3. **Zettelkasten Workflow** — Note management, exercise parsing, Moodle export,
   knowledge graph
...
| [ITEP-0008](ITEP-0008-general-project-nomenclature.md)      | General project nomenclature: discipline, area, year and project initials; amended 2026-05-27 to clarify Topic DB root change; amended 2026-08-08 to correct the physical-nesting claim (layout is flat, per ITEP-0000 — naming/DB hierarchy remains implemented) | ITeP         | Amended (2026-08-08) | ITEP-0000, ITEP-0004             |
...
| [ITEP-0011](ITEP-0011-vault-unification.md)                 | Vault unification: notes layer relocates LocalBase → GlobalBase; per-project `.md` files unify under `<vault_root>/notes/{permanent,literature,fleeting}`; amended 2026-07-05 — permanent/literature notes coexist flat in the vault root, `type:` frontmatter is the only type authority, directory placement carries no semantics | ITeP         | Implemented (amended 2026-07-05) | 0003, 0004, ITEP-0001, ITEP-0010 |
| [0008](0008-xdg-directory-layout.md)                        | XDG directory layout                                                                                                                                      | Zettelkasten | Accepted (amended 2026-06-05) | —                                |
...
| [ITEP-0012](ITEP-0012-concept-orm.md)   | Concept ORM surface: taxonomy tree, `concepts:` resolver, `--strict-concepts` validator; amended for `content_id` re-rooting, `domain` column, `ExerciseConcept` M2M (migration 0009); amended 2026-05-27 for `Concept.main_topic` chain post-Topic re-root (Phase 4B, migration 0011); amended 2026-07-04 (slug-only contract) | ITeP | Implemented (Phase 5, amended 2026-05-27, amended 2026-07-04) | ITEP-0002, ITEP-0006, ITEP-0009, ITEP-0011 |
...
| [ITEP-0015](ITEP-0015-editor-first-authoring-tooling.md) | Editor-first authoring tooling for the note graph | ITeP | Accepted (2026-07-05, scope corrected) | ITEP-0011, ITEP-0012, ITEP-0013 |
| [0021](0021-vault-full-text-search.md) | Vault full-text search via SQLite FTS5 | Zettelkasten | Accepted (2026-09-10, implemented W1 F2) | ITEP-0011, 0010, ITEP-0014 |
...
## Graph CLI & Bulk Import Contracts

| ADR                                             | Title                                                     | Domain | Status                    | Depends On    |
| ------------------------------------------------ | ---------------------------------------------------------- | ------ | -------------------------- | -------------- |
| [0017](0017-graph-neighbors-json-contract.md)   | `graph neighbors --json` output contract                 | Graph  | Accepted                  | 0007           |
| [0018](0018-bulk-import-contract.md)            | Bulk-import contract (`workflow import`; `topic import` alias) | Importer | Accepted (amended 2026-06-03) | ITEP-0002, ITEP-0006, ITEP-0012 |
...
| [0020](0020-bibliography-module-boundary.md)                 | Bibliography module boundary: foundation layer + 0/1/2+ lookup contract | Bibliography | Accepted | 0007, 0019, PRISMA-0005 |
...
| ADR                                         | Title                                                                              | Domain | Status   | Depends On                        |
| ------------------------------------------- | ---------------------------------------------------------------------------------- | ------ | -------- | --------------------------------- |
| [0014](0014-zettelkasten-implementation.md) | Zettelkasten implementation: macros, note model, workspace init, Markdown pipeline | System | Accepted | 0001, 0002, 0003, 0007, ITEP-0000 |

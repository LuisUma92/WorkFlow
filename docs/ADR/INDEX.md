...
| [ITEP-0011](ITEP-0011-vault-unification.md)                 | Vault unification: notes layer relocates LocalBase → GlobalBase; per-project `.md` files unify under `<vault_root>/notes/{permanent,literature,fleeting}` | ITeP         | Accepted (P0–P3 shipped) | 0003, 0004, ITEP-0001, ITEP-0010 |
